...
Technical reference for setting up, running, and extending this project.
For a plain-language overview of what this project does and why, see
[`README.md`](../README.md).
